...
import { index as leaveTypeIndex, update as leaveTypeUpdate } from '@/actions/App/Http/Controllers/Hr/LeaveTypeController';
...
export default function LeaveTypeEdit({ leaveType }: PageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(leaveTypeUpdate.url(leaveType.id));
    };

    return (
        <>
            <Head title={`Edit Leave Type: ${leaveType.name}`} />
            ...
            <div className="flex flex-col gap-6 p-4">
                <div className="flex items-center gap-4">
                    ...
                    <Heading title={`Edit Leave Type: ${leaveType.name}`} description="Update the details for this leave type." />
                </div>
