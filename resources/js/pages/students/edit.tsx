...
export default function StudentEdit({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        home_postalcode: student.home_postalcode || '',
        current_address: student.current_address || '',
        current_town: student.current_town || '',
        current_province: student.current_province || '',
        current_postalcode: student.current_postalcode || '',
    ...
    function handleSubmit(e: FormEvent) {
        e.preventDefault();
        post(StudentController.update.url(student.id), {
            forceFormData: true,
        });
    }
