...
export default function AssignmentsCreate({ employees, parentAssignments }: PageProps) {
        ...
        <div className="container mx-auto py-8 px-4 max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Assign a task to a team member.</p>
                </div>
            </div>
