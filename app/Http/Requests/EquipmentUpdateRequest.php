...
class EquipmentUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'equipment_number' => ['required', 'string', 'unique:equipment,equipment_number,'.$this->equipment->id],
            'serial_number' => ['nullable', 'string', 'unique:equipment,serial_number,'.$this->equipment->id],
